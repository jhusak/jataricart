...
The cartridge is driven by addresses D500-D580; write to D500 sets the first bank - this is default boot bank. Write to D501 sets second bank etc. The max bank is set by write to D57F; write to D580 (well, the eight bit of address is set) switches off the cartridge. The banks may have repeated contents if there are less of them than 128.
